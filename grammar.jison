...
"list"              {lexico.push("LIST");        return 'RLIST';}
"add"               {lexico.push("ADD");         return 'RADD';}
...
"\t"                            {return 'TABULACION';}
/*---------------------------------------------------------------*/
.                               {console.log("error lexico en "+yylloc.first_line+","+yylloc.first_column);val = new NODO_REPORTE_ERROR("Lexico","El caracter \""+yytext+"\" no pertenece al lenguaje.", yylloc.first_line,yylloc.first_column); reporte_errores.push(val);}
...
instrucciones :    instrucciones instruccion        {lista_temporal = $1;  lista_temporal_2= lista_temporal[0]; lista_temporal_2.push($2[0]);
                                                    nodo_graf = new NODO_GRAFICAS( "INSTRUCCIONES", @1.first_line, @1.first_column, "yellow" );
                                                    nodo_prueba= $1[1];
                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                    nodo_prueba = new NODO_GRAFICAS( "INSTRUCCION", @1.first_line, @1.first_column, "yellowgreen" );
                                                    nodo_prueba.agregar_hijo($2[1]);
                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                    lista_temporal = []; lista_temporal.push(lista_temporal_2); lista_temporal.push(nodo_graf); $$ = lista_temporal;     }
            |      instruccion {   let lstsent = [];        lstsent.push($1[0]);   
                                nodo_graf = new NODO_GRAFICAS( "INSTRUCCIONES", @1.first_line, @1.first_column, "yellow" );
                                nodo_prueba = new NODO_GRAFICAS( "INSTRUCCION", @1.first_line, @1.first_column, "yellowgreen" );
                                nodo_prueba.agregar_hijo($1[1]);
                                nodo_graf.agregar_hijo(nodo_prueba);
                                lista_temporal = []; lista_temporal.push(lstsent); lista_temporal.push(nodo_graf);  $$ = lista_temporal;      }
...
instruccion :                   DECLARACION_VARIABLE ';'    { lista_temporal2= $1[0];lista_temporal=[]; lista_temporal.push(lista_temporal2); nodo_graf = $1[1]; lista_temporal.push(nodo_graf); $$ = lista_temporal; }
                            ...
                            |   ASIGNACION_LISTAS         { lista_temporal=[]; lista_temporal.push($1[0]); nodo_graf = $1[1]; lista_temporal.push(nodo_graf); $$ = lista_temporal; }
                            |   AGREGAR_DATO_LISTAS  ';'    { lista_temporal=[]; lista_temporal.push($1[0]); nodo_graf = $1[1]; lista_temporal.push(nodo_graf); $$ = lista_temporal; }
                            ...
                            |   error PTCOMA                {console.error('ERROR SINTACTICO: '+ yytext+' , '+this._$.first_line+' , '+this._$.first_column);
                                                            }
                            |   error                       {console.error('ERROR SINTACTICO: '+ yytext+' , '+this._$.first_line+' , '+this._$.first_column);
...
FUNCION_MAIN:               RMAIN id '('PARAMETROS_LLAMADA')'             {lista_temporal = []; val = new LLAMADA_MAIN($2,$4[0], @1.first_line, @1.first_column);lista_temporal.push(val);
                                                                        ...
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA:MAIN", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_prueba=new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "gray" );
...
DECLARACION_VECTORES:         TIPO '[' ']' id '=' 'RNEW' TIPO '['EXPRESION']' {val = new DECLARACION_VECTOR_TIPO1($1[0], $4, [],$9[0],@4.first_line,@4.first_column );
                                                                                ...
                                                                                nodo_graf.agregar_hijo(nodo_prueba);
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "=", @1.first_line, @1.first_column, "black" ));
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: NEW", @1.first_line, @1.first_column, "black" ));
...
; 
DECLARACION_LISTAS: RLIST '<' TIPO '>' id '=' RNEW RLIST '<' TIPO '>' {lista_temporal = [];val = new DECLARACION_LISTA_TIPO1($3[0], $5,[], $10[0],@5.first_line,@5.first_column ); lista_temporal.push(val);
                                                                        nodo_graf = new NODO_GRAFICAS( "DECLARACION LISTA", @1.first_line, @1.first_column, "skyblue" );
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: LIST", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "<", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo($3[1]);
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ">", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );
                                                                        nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $5, @1.first_line, @1.first_column, "black" ))//id
                                                                        nodo_graf.agregar_hijo(nodo_prueba);
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "=", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: NEW", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: LIST", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "<", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo($10[1]);
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ">", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                                                        lista_temporal.push(nodo_graf); $$ = lista_temporal;
                                                                        }
                    |RLIST '<' TIPO '>' id '=' EXPRESION                {lista_temporal = [];lista_temporal_2=[]; lista_temporal_2.push($7[0]);
                                                                        val = new DECLARACION_LISTA_TIPO1($3[0], $5,lista_temporal_2,$3[0],@5.first_line,@5.first_column ); lista_temporal.push(val);
...
AGREGAR_DATO_LISTAS:    id '.' RADD '(' EXPRESION ')'       {lista_temporal = []; val = new AGREGAR_A_LISTA($1,$5[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                            nodo_graf = new NODO_GRAFICAS( "AGREGAR DATO LISTA", @1.first_line, @1.first_column, "green" );
                                                            nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "green" );
                                                            nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ))//id
                                                            nodo_graf.agregar_hijo(nodo_prueba);
                                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ".", @1.first_line, @1.first_column, "black" ));
                                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: ADD", @1.first_line, @1.first_column, "black" ));
                                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
...
LISTA_EXPRESIONES:            LISTA_EXPRESIONES ',' EXPRESION { lista_temporal = $1; lista_temporal_2 = lista_temporal[0]; lista_temporal_2.push($3[0]);
                                                                nodo_graf = new NODO_GRAFICAS( "LISTA DE EXPRESIONES", @1.first_line, @1.first_column, "skyblue" );
                                                                nodo_graf.agregar_hijo($1[1]);
                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( ",", @1.first_line, @1.first_column, "black" ));
                                                                nodo_graf.agregar_hijo($3[1]);
                                                                lista_temporal = []; lista_temporal.push(lista_temporal_2); lista_temporal.push(nodo_graf); $$ = lista_temporal;
                            ...
                            | EXPRESION                     {   let lstexp = [];        lstexp.push($1[0]); 
                                                                nodo_graf = new NODO_GRAFICAS( "LISTA DE EXPRESIONES", @1.first_line, @1.first_column, "skyblue" ); 
                                                                nodo_graf.agregar_hijo($1[1]);
                                                                lista_temporal = []; lista_temporal.push(lstexp); lista_temporal.push(nodo_graf);  $$ = lista_temporal
                                                            }                                  
;
DECLARACION_METODO:           RVOID id '('PARAMETROS')' INSTRUCCIONES_FUNCION     { let tipo_void = new Tipo(TIPO_DATO.VOID);
                                                                                    lista_temporal = [];val = new DECLARACION_METODO(tipo_void,$2,$4[0],$6[0], @2.first_line, @2.first_column); lista_temporal.push(val);
                            ...
                            | RVOID id '('')' INSTRUCCIONES_FUNCION               {let tipo_void_2 = new Tipo(TIPO_DATO.VOID);
                                                                                    lista_temporal = []; val = new DECLARACION_METODO(tipo_void_2,$2,[],$5[0], @2.first_line, @2.first_column); lista_temporal.push(val);
                                                                                    nodo_graf = new NODO_GRAFICAS( "DECLARACION METODO", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: VOID", @1.first_line, @1.first_column, "black" ));
                                                                                    nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $2, @1.first_line, @1.first_column, "black" ));
                                                                                    nodo_graf.agregar_hijo(nodo_prueba);
...
;
DECLARACION_FUNCION:           TIPO id '('PARAMETROS')' INSTRUCCIONES_FUNCION     {lista_temporal = [];val = new DECLARACION_METODO($1[0],$2,$4[0],$6[0], @2.first_line, @2.first_column); lista_temporal.push(val);
                                                                                    nodo_graf = new NODO_GRAFICAS( "DECLARACION FUNCION", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_graf.agregar_hijo($1[1]);
                                                                                    nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $2, @1.first_line, @1.first_column, "black" ))
                                                                                    nodo_graf.agregar_hijo(nodo_prueba);
                            ...
                            | TIPO id '('')' INSTRUCCIONES_FUNCION               {lista_temporal = []; val = new DECLARACION_METODO($1[0],$2,[],$5[0], @2.first_line, @2.first_column); lista_temporal.push(val);
                                                                                    nodo_graf = new NODO_GRAFICAS( "DECLARACION FUNCION", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_graf.agregar_hijo($1[1]);
                                                                                    nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );
                                                                                    nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $2, @1.first_line, @1.first_column, "black" ));
...
PARAMETROS:                   PARAMETROS ',' DECLARACION_VACIA_METODO     {lista_temporal = $1; lista_temporal_2 = lista_temporal[0]; lista_temporal_2.push($3[0]);
                                                                            nodo_graf = new NODO_GRAFICAS( "PARAMETRO", @3.first_line, @3.first_column, "black" );
                                                                            nodo_graf.agregar_hijo($1[1]);
                                                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ",", @3.first_line, @3.first_column, "black" ))
                                                                            nodo_graf.agregar_hijo($3[1]);
                            ...
                            | DECLARACION_VACIA_METODO                   { let lstmet = [];        lstmet.push($1[0]);  
                                                                        ...
                                                                        lista_temporal = []; lista_temporal.push(lstmet); lista_temporal.push(nodo_graf);$$ = lista_temporal;
                                                                        }
;
DECLARACION_VACIA_METODO:     TIPO  id           {lista_temporal = []; val = new DECLARACION_PARAMETRO($1[0], $2, undefined, @2.first_line, @2.first_column);val =val.ejecutar();lista_temporal.push(val);
                                                nodo_graf = new NODO_GRAFICAS( "DECLARACION VARIABLE", @1.first_line, @1.first_column, "skyblue" );
                                                nodo_graf.agregar_hijo($1[1]);
                                                nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );
                                                nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $2, @1.first_line, @1.first_column, "black" ))
                                                nodo_graf.agregar_hijo(nodo_prueba);
...
LLAMADA_METODOS:              id '('PARAMETROS_LLAMADA')'             {lista_temporal = []; val = new LLAMADA_METODO($1,$3[0], @1.first_line, @1.first_column);lista_temporal.push(val);
                                                                        nodo_graf = new NODO_GRAFICAS( "LLAMADA METODO O FUNCION", @1.first_line, @1.first_column, "purple" );
                                                                        nodo_prueba=new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "purple" );
...
PARAMETROS_LLAMADA:           PARAMETROS_LLAMADA ',' EXPRESION    {lista_temporal = $1; lista_temporal_2 = lista_temporal[0]; lista_temporal_2.push($3[0]);lista_temporal.push(lista_temporal_2);
                                                                    nodo_graf = new NODO_GRAFICAS( "PARAMETROS.", @1.first_line, @1.first_column, "gray" );
                                                                    nodo_graf.agregar_hijo($1[1]);
                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ",", @1.first_line, @1.first_column, "gray" ));
                                                                    nodo_graf.agregar_hijo($3[1]);
                                                                    lista_temporal[1]= nodo_graf; $$ = lista_temporal;
                                                                    }
...
ASIGNACION_VARIABLE  :        id '=' EXPRESION       { lista_temporal = []; val = new ASIGNACION_VARIABLE($1, $3[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                    ...
                                                    nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "green" );//ID
                                                    nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                    nodo_prueba = new NODO_GRAFICAS( "=", @1.first_line, @1.first_column, "black" );//=
                                                    nodo_graf.agregar_hijo(nodo_prueba);
...
;
ASIGNACION_LISTAS :         id '[''[' EXPRESION ']'']' '=' EXPRESION ';'  {lista_temporal = []; val = new ASIGNACION_LISTA($1, $4[0], $8[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                                    nodo_graf = new NODO_GRAFICAS( "ASIGNACION LISTA", @1.first_line, @1.first_column, "green" );
                                                                    nodo_prueba = new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "skyblue" );//ID
                                                                    nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));
                                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "[", @1.first_line, @1.first_column, "black" ));
...
FUNCION_IF:                   RIF '(' EXPRESION ')' INSTRUCCIONES_FUNCION                             {lista_temporal = []; val = new IF($3[0], $5[0], [], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                                                                    nodo_graf = new NODO_GRAFICAS( "FUNCION IF", @1.first_line, @1.first_column, "orange" );
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: IF", @1.first_line, @1.first_column, "black" ));
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                                                                    nodo_graf.agregar_hijo($3[1]);
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "{", @1.first_line, @1.first_column, "black" ));
                            ...
                            | RIF '(' EXPRESION ')' INSTRUCCIONES_FUNCION RELSE INSTRUCCIONES_FUNCION {lista_temporal = []; val = new IF($3[0], $5[0], $7[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                                                                    ...
                                                                                                    nodo_graf.agregar_hijo($5[1]);
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "}", @1.first_line, @1.first_column, "black" ));
                                                                                                    nodo_prueba = new NODO_GRAFICAS( "PALABRA RESERVADA: ELSE", @1.first_line, @1.first_column, "black" );
                                                                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "{", @1.first_line, @1.first_column, "black" ));
                                                                                                    nodo_graf.agregar_hijo($7[1]);
                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "}", @1.first_line, @1.first_column, "black" ));
...
FUNCION_PRINT:                RPRINT '('EXPRESION')'   {lista_temporal = []; val = new PRINT($3[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                        nodo_graf = new NODO_GRAFICAS( "FUNCION PRINT", @1.first_line, @1.first_column, "orange" );
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: PRINT", @1.first_line, @1.first_column, "black" ));
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                        nodo_graf.agregar_hijo($3[1]);
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
...
FUNCION_WHILE:                RWHILE '(' EXPRESION ')'  INSTRUCCIONES_FUNCION  {lista_temporal = []; val = new WHILE($3[0],$5[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                                                nodo_graf = new NODO_GRAFICAS( "FUNCION WHILE", @1.first_line, @1.first_column, "orange" );
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: WHILE", @1.first_line, @1.first_column, "black" ));
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                                                nodo_graf.agregar_hijo($3[1]);
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "{", @1.first_line, @1.first_column, "black" ));
...
FUNCION_FOR:                  RFOR '(' DEC_O_ASIG ';' EXPRESION ';' ASIGNACION_VARIABLE ')' INSTRUCCIONES_FUNCION  {lista_temporal = []; val = new FOR($3[0],$5[0],$7[0],$9[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                                                                                    nodo_graf = new NODO_GRAFICAS( "FUNCION FOR", @1.first_line, @1.first_column, "orange" );
                                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: FOR", @1.first_line, @1.first_column, "black" ));
                                                                                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                                                                                    nodo_graf.agregar_hijo($3[1]);
                                                                                                                    //nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                                                                                                    nodo_graf.agregar_hijo($5[1]);
...
FUNCION_DO_WHILE:             RDO INSTRUCCIONES_FUNCION RWHILE'(' EXPRESION ')'   {lista_temporal = [];val = new DO_WHILE($5[0],$2[0], @1.first_line, @1.first_column);lista_temporal.push(val);
                                                                                ...
                                                                                nodo_graf = new NODO_GRAFICAS( "FUNCION DO WHILE", @1.first_line, @1.first_column, "orange" );
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: DO", @1.first_line, @1.first_column, "black" ));
                                                                                nodo_graf.agregar_hijo(new NODO_GRAFICAS( "{", @1.first_line, @1.first_column, "black" ));
...
FUNCION_SWITCH:               RSWITCH '(' EXPRESION ')' '{' CASES_SWITCH         '}'  {lista_temporal = []; val = new SWITCH($3[0],$6[0],[],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                                                        nodo_graf = new NODO_GRAFICAS( "FUNCION SWITCH", @1.first_line, @1.first_column, "orange" );
                                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: SWITCH", @1.first_line, @1.first_column, "black" ));
                                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                                                        nodo_graf.agregar_hijo( $3[1]);
                                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "{", @1.first_line, @1.first_column, "black" ));
...
CASES_SWITCH: CASES_SWITCH CASE_SWITCH  {lista_temporal = $1; lista_temporal_2 = lista_temporal[0]; lista_temporal_2.push($2[0]); 
                                        nodo_graf = new NODO_GRAFICAS( "CASES SWITCH", @1.first_line, @1.first_column, "orange" );
                                        nodo_graf.agregar_hijo($1[1]);
                                        nodo_graf.agregar_hijo($2[1]);
                                        lista_temporal = [];lista_temporal.push(lista_temporal_2); lista_temporal.push(nodo_graf);  $$ = lista_temporal;
                                        }
...
CASE_SWITCH: RCASE EXPRESION ':'  INSTRUCCIONES_SWITCH  {lista_temporal = []; val = new CASE($2[0],$4[0], @1.first_line, @1.first_column); lista_temporal.push(val);
                                                        nodo_graf = new NODO_GRAFICAS( "CASE", @1.first_line, @1.first_column, "orange" );
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: CASE", @1.first_line, @1.first_column, "black" ));
                                                        nodo_graf.agregar_hijo($2[1]);
                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ":", @1.first_line, @1.first_column, "black" ));
                                                        nodo_prueba = $4[1];
                                                        nodo_graf.agregar_hijo(nodo_prueba);
...
DEFAULT: RDEFAULT ':'  INSTRUCCIONES_SWITCH      {lista_temporal = []; val = $3[0]; lista_temporal.push(val);
                                                    ...
                                                    nodo_graf = new NODO_GRAFICAS( "DEFAULT", @1.first_line, @1.first_column, "orange" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: DEFAULT", @1.first_line, @1.first_column, "black" ));
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ":", @1.first_line, @1.first_column, "black" ));
                                                    nodo_prueba = $3[1];
                                                    nodo_graf.agregar_hijo(nodo_prueba);
                                                    lista_temporal.push(nodo_graf); $$ = lista_temporal;
...
SENTENCIA_BREAK:    RBREAK ';'              {lista_temporal = []; val = new SENT_BREAK(@1.first_line, @1.first_column);lista_temporal.push(val);
                                            nodo_graf = new NODO_GRAFICAS( "BREAK", @1.first_line, @1.first_column, "red" );
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: BREAK", @1.first_line, @1.first_column, "black" ));
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                            lista_temporal.push(nodo_graf); $$ = lista_temporal;
                                            }
;
SENTENCIA_CONTINUE:    RCONTINUE ';'        {lista_temporal = []; val = new SENT_CONTINUE(@1.first_line, @1.first_column);lista_temporal.push(val);
                                            nodo_graf = new NODO_GRAFICAS( "CONTINUE", @1.first_line, @1.first_column, "red" );
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: CONTINUE", @1.first_line, @1.first_column, "black" ));
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                            lista_temporal.push(nodo_graf); $$ = lista_temporal;
                                            }
;
SENTENCIA_RETURN:    RRETURN EXPRESION ';'            {lista_temporal = []; val = new SENT_RETURN($2[0], @1.first_line, @1.first_column);lista_temporal.push(val);
                                            nodo_graf = new NODO_GRAFICAS( "RETURN", @1.first_line, @1.first_column, "red" );
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: RETURN", @1.first_line, @1.first_column, "black" ));
                                            nodo_graf.agregar_hijo($2[1]);   
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                            lista_temporal.push(nodo_graf); $$ = lista_temporal;
                                            }
                    | RRETURN ';'           {lista_temporal = []; val = new SENT_RETURN("", @1.first_line, @1.first_column);lista_temporal.push(val);
                                            nodo_graf = new NODO_GRAFICAS( "RETURN", @1.first_line, @1.first_column, "red" );
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: RETURN", @1.first_line, @1.first_column, "black" ));
                                            nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ));
                                            lista_temporal.push(nodo_graf); $$ = lista_temporal;
...
TIPO    :       RINT          { val = new Tipo(TIPO_DATO.INT);     nodo_graf = new NODO_GRAFICAS( "TIPO", @1.first_line, @1.first_column, "blue" );    nodo_prueba = new NODO_GRAFICAS( "INT", @1.first_line, @1.first_column, "black" );    nodo_graf.agregar_hijo(nodo_prueba);  lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
        |       RBOOLEAN      { val = new Tipo(TIPO_DATO.BOOLEAN); nodo_graf = new NODO_GRAFICAS( "TIPO", @1.first_line, @1.first_column, "blue" );    nodo_prueba = new NODO_GRAFICAS( "BOOLEAN", @1.first_line, @1.first_column, "black" );    nodo_graf.agregar_hijo(nodo_prueba);  lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
        |       RSTRING       { val = new Tipo(TIPO_DATO.STRING);  nodo_graf = new NODO_GRAFICAS( "TIPO", @1.first_line, @1.first_column, "blue" );    nodo_prueba = new NODO_GRAFICAS( "STRING", @1.first_line, @1.first_column, "black" );    nodo_graf.agregar_hijo(nodo_prueba);  lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
        |       RDOUBLE       { val = new Tipo(TIPO_DATO.DOUBLE);  nodo_graf = new NODO_GRAFICAS( "TIPO", @1.first_line, @1.first_column, "blue" );    nodo_prueba = new NODO_GRAFICAS( "DOUBLE", @1.first_line, @1.first_column, "black" );    nodo_graf.agregar_hijo(nodo_prueba);  lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
        |       RCHAR         { val = new Tipo(TIPO_DATO.CHAR);    nodo_graf = new NODO_GRAFICAS( "TIPO", @1.first_line, @1.first_column, "blue" );    nodo_prueba = new NODO_GRAFICAS( "CHAR", @1.first_line, @1.first_column, "black" );    nodo_graf.agregar_hijo(nodo_prueba);  lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
; 

EXPRESION :   EXPRESION '+' EXPRESION               {val = new OPERACIONES($1[0], $2, $3[0], @2.first_line, @2.first_column);      nodo_graf = new NODO_GRAFICAS( "OPERACION ARITMETICA", @1.first_line, @1.first_column, "blue" );lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal
    ...
    |   EXPRESION '-' EXPRESION                     {val = new OPERACIONES($1[0], $2, $3[0], @2.first_line, @2.first_column);      nodo_graf = new NODO_GRAFICAS( "OPERACION ARITMETICA", @1.first_line, @1.first_column, "blue" );lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal
                                                    nodo_graf.agregar_hijo($1[1]);nodo_graf.agregar_hijo(new NODO_GRAFICAS( "-", @1.first_line, @1.first_column, "black" ));nodo_graf.agregar_hijo($3[1]);
                                                    }
    |   EXPRESION '*' EXPRESION                     {val = new OPERACIONES($1[0], $2, $3[0], @2.first_line, @2.first_column);      nodo_graf = new NODO_GRAFICAS( "OPERACION ARITMETICA", @1.first_line, @1.first_column, "blue" );lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal
                                                    nodo_graf.agregar_hijo($1[1]);nodo_graf.agregar_hijo(new NODO_GRAFICAS( "*", @1.first_line, @1.first_column, "black" ));nodo_graf.agregar_hijo($3[1]);
    ...
    |   '-' EXPRESION %prec negativo                {val = new OPERACION_UNARIA($1, $2[0], @2.first_line, @2.first_column);        nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "-", @1.first_line, @1.first_column, "black" ));nodo_graf.agregar_hijo($2[1]);
                                                    }
    |   '(' EXPRESION ')'                           {val = $2[0];                                                                  nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                    nodo_graf.agregar_hijo($2[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                    }
    ...
    |   RTOLOWER '(' EXPRESION ')'                  {lista_temporal = []; val = new TO_LOWER($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    ...
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TOLOWER", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RTOUPPER '(' EXPRESION ')'                  {lista_temporal = []; val = new TO_UPPER($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    ...
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TOUPPER", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RLENGTH '(' EXPRESION ')'                  {lista_temporal = []; val = new LENGHT($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "LENGTH", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: LENGTH", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RTRUNCATE '(' EXPRESION ')'                  {lista_temporal = []; val = new TRUNCATE($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "TRUNCATE", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TRUNCATE", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RROUND '(' EXPRESION ')'                    {lista_temporal = []; val = new ROUND($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "ROUND", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: ROUND", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RTYPEOF '(' EXPRESION ')'                    {lista_temporal = []; val = new TYPEOF($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "TYPEOF", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TYPEOF", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   RTOSTRING '(' EXPRESION ')'                 {lista_temporal = []; val = new TOSTRING($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "TOSTRING", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TOSTRING", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ))
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ";", @1.first_line, @1.first_column, "black" ))
    ...
    |   EXPRESION '?' EXPRESION ':' EXPRESION       {lista_temporal = []; val = new OPERACION_TERNARIA($1[0], $3[0], $5[0], @2.first_line, @2.first_column); lista_temporal.push(val);
                                                    nodo_graf = new NODO_GRAFICAS( "OPERACION TERNARIA", @1.first_line, @1.first_column, "blue" );
                                                    nodo_graf.agregar_hijo($1[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( "?", @1.first_line, @1.first_column, "black" ));
                                                    nodo_graf.agregar_hijo($3[1]);
                                                    nodo_graf.agregar_hijo(new NODO_GRAFICAS( ":", @1.first_line, @1.first_column, "black" ));
    ...
    |   id '[''[' EXPRESION']'']'                                        {lista_temporal = []; val = new VALIDAR_EXISTE_LISTA($1,$4[0],@1.first_line, @1.first_column);lista_temporal.push(val);
                                                                        nodo_graf = new NODO_GRAFICAS( "ACCESO A LISTAS", @1.first_line, @1.first_column, "blue" );
                                                                        nodo_prueba=new NODO_GRAFICAS( "ID", @1.first_line, @1.first_column, "black" );
                                                                        nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ))
                                                                        nodo_graf.agregar_hijo(nodo_prueba);
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "[", @1.first_line, @1.first_column, "black" ));
    ...
    |   RTOCHARARRAY '('EXPRESION')'                                    {lista_temporal = []; val = new TOCHARARRAY($3[0],@1.first_line, @1.first_column); lista_temporal.push(val);
                                                                        nodo_graf = new NODO_GRAFICAS( "TOCHARARRAY", @1.first_line, @1.first_column, "blue" );
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "PALABRA RESERVADA: TOCHARARRAY", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( "(", @1.first_line, @1.first_column, "black" ));
                                                                        nodo_graf.agregar_hijo($3[1]);
                                                                        nodo_graf.agregar_hijo(new NODO_GRAFICAS( ")", @1.first_line, @1.first_column, "black" ));
                                                                        lista_temporal.push(nodo_graf); $$ = lista_temporal;
    ...
    |   id                                          {val = new VALIDAR_EXISTE_VARIABLE($1,@1.first_line,@1.first_column);          nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_prueba = new NODO_GRAFICAS( "VARIABLE", @1.first_line, @1.first_column, "skyblue" );nodo_prueba.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" )); nodo_graf.agregar_hijo(nodo_prueba);lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   id '['EXPRESION']'                          {val = new VALIDAR_EXISTE_VECTOR($1,$3[0],@1.first_line,@1.first_column);      nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   ENTERO                                      {val = new Valor($1,"INT",@1.first_line,@1.first_column);                      nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   DECIMAL                                     {val = new Valor($1,"DOUBLE",@1.first_line,@1.first_column);                   nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   CARACTER                                    {val = new Valor($1,"CHAR",@1.first_line,@1.first_column);                     nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   CADENA                                      {val = new Valor($1,"STRING",@1.first_line,@1.first_column);                   nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( $1, @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    |   RTRUE                                       {val = new Valor($1,"true",@1.first_line,@1.first_column);                     nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( "TRUE", @1.first_line, @1.first_column, "black" ));lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal   }
    |   RFALSE                                      {val = new Valor($1,"false",@1.first_line,@1.first_column);                    nodo_graf = new NODO_GRAFICAS( "EXPRESION", @1.first_line, @1.first_column, "blue" );     nodo_graf.agregar_hijo(new NODO_GRAFICAS( "FALSE", @1.first_line, @1.first_column, "black" )); lista_temporal = [];lista_temporal.push(val); lista_temporal.push(nodo_graf); $$= lista_temporal}
    //|   error                                       {console.error('ERROR SINTACTICO: '+ yytext+' , '+this._$.first_line+' , '+this._$.first_column);}
;
